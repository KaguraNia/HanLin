...
# os.system("pip install -r PaddleOCR/requirements.txt -i https://pypi.tuna.tsinghua.edu.cn/simple")
...
def get_test_images(infer_file):
    """
    Generate inference image list based on txt file 
    """
...
def main(model_dir, args,):
    ...
    for ino in range(len(img_list)):
        context = valid_image_file_list[ino] + "\t" + rec_res[ino][0] + "\n"
