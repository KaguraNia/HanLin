...
Page({
  ...
  createSimulationData: function () {
    ...
    var abData = [];
    for (var i = 0; i < 5; i++) {
      const a1 = Math.random() * (40) + 80;
      const a2 = Math.random() * (40) + 100;
      const a3 = Math.random() * (40) + 110;
      const a4 = Math.random() * (25) + 70;
      const a5 = Math.random() * (25) + 70;
      const a6 = Math.random() * (25) + 75;
      const a = a1 + a2 + a3 + a4 + a5 + a6;

      const aa1 = Math.random() * (40) + 70;
      const aa2 = Math.random() * (30) + 80;
      const aa3 = Math.random() * (30) + 90;
      const aa4 = Math.random() * (25) + 50;
      const aa5 = Math.random() * (25) + 60;
      const aa6 = Math.random() * (25) + 60;
